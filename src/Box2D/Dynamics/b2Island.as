	...
	public function Solve(step:b2TimeStep, gravity:b2Vec2, allowSleep:Boolean) : void
	{
		...
		for (i = 0; i < m_bodyCount; ++i)
		{
			...
			if (b.GetType() != b2Body.b2_dynamicBody)
				continue;
			var myGravity:b2Vec2;
			if(b.m_myGravity)
				myGravity = b.m_myGravity;
			else
				myGravity = gravity;
			// Integrate velocities.
			//b.m_linearVelocity += step.dt * (gravity + b.m_invMass * b.m_force);
			b.m_linearVelocity.x += step.dt * (myGravity.x + b.m_invMass * b.m_force.x);
			b.m_linearVelocity.y += step.dt * (myGravity.y + b.m_invMass * b.m_force.y);
